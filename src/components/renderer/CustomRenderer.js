...
export default class CustomRenderer extends BaseRenderer {
    ...
    canRender(element) {
        ...
        //return (isAny(element, ['bpmn:Choreography','bpmn:ChoreographyTask', 'bpmn:Event', 'bpmn:ChoreographyActivity','bpmn:Participant'])) ;//&& !element.labelTarget;
       console.log("primo element",element);
       console.log("orimo render", this.bpmnRenderer);
        return element; 
    }

    getShapePath(shape){
        //console.log("shapeeeeeeeeeeee", shape)
        return shape;
    }
    ...
    drawShape(parentNode, element) {
        ...
        //console.log("participants",element.businessObject.$parent.participants[0]);
        //console.log("elementtt",is(element.businessObject.$parent.flowElements[1],"bpmn:ChoreographyTask"));
        ...
        //console.log('element',element.businessObject.modelerTemplate)
           ...
           // console.log("div", div.innerHTML);
            ...
            console.log("paren", d3.select("path"));
        ...
        if (is(element, 'bpmn:Participant') ) {
            //console.log('element',element.businessObject.modelerTemplate)
            //const rect = drawRect(parentNode, 100, 80, TASK_BORDER_RADIUS, '#52B415');
            console.log("dai che anche qui ci siamo", element);
            /* var div = document.createElement('div');
            // assing your HTML to div's innerHTML
            div.innerHTML = parentNode;
            console.log("div", div.innerHTML);
