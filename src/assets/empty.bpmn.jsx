...
<bpmn2:definitions xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:bpmn2="http://www.omg.org/spec/BPMN/20100524/MODEL" xmlns:bpmndi="http://www.omg.org/spec/BPMN/20100524/DI" xmlns:dc="http://www.omg.org/spec/DD/20100524/DC" xmlns:di="http://www.omg.org/spec/DD/20100524/DI" xmlns:xs="http://www.w3.org/2001/XMLSchema" id="_tTv5YOycEeiHGOQ2NkJZNQ" targetNamespace="http://bpmn.io/schema/bpmn">
  <bpmn2:choreography id="Choreography_1wp1o08" name="PropertyTransaction">
    ...
    <bpmn2:messageFlow id="MessageFlow_14imfsu" sourceRef="Participant_0vb4wl7" targetRef="Participant_1u1zdeg" messageRef="Message_0n3xup4" />
    ...
    <bpmn2:messageFlow id="MessageFlow_1eb7dbp" sourceRef="Participant_0hk3i22" targetRef="Participant_031en92" messageRef="Message_1d9ykc4" />
    ...
    <bpmn2:choreographyTask id="ChoreographyTask_0yuyl8m" name="Add mortgage deeds" initiatingParticipantRef="Participant_031en92">
      ...
      <bpmn2:messageFlowRef>MessageFlow_1eb7dbp</bpmn2:messageFlowRef>
  ...
  <bpmndi:BPMNDiagram id="BPMNDiagram_141updn">
    <bpmndi:BPMNPlane id="BPMNPlane_0xkw46k" bpmnElement="Choreography_1wp1o08">
      ...
      <bpmndi:BPMNShape id="BPMNShape_0wy0k62" bpmnElement="Participant_031en92" isMessageVisible="true" participantBandKind="top_initiating" choreographyActivityShape="ChoreographyTask_0axlrdi_di">
        <dc:Bounds x="350" y="270" width="100" height="20" />
      </bpmndi:BPMNShape>
      <bpmndi:BPMNShape id="BPMNShape_010qbwp" bpmnElement="Participant_0vb4wl7" isMessageVisible="true" participantBandKind="bottom_non_initiating" choreographyActivityShape="ChoreographyTask_0axlrdi_di">
      ...
      <bpmndi:BPMNShape id="BPMNShape_1f0s3gd" bpmnElement="Participant_031en92" isMessageVisible="true" participantBandKind="top_initiating" choreographyActivityShape="ChoreographyTask_08zltwe_di">
        <dc:Bounds x="510" y="270" width="100" height="20" />
      </bpmndi:BPMNShape>
      <bpmndi:BPMNShape id="BPMNShape_1oqu9my" bpmnElement="Participant_1u1zdeg" isHorizontal="true" isMessageVisible="true" participantBandKind="bottom_non_initiating" choreographyActivityShape="ChoreographyTask_08zltwe_di">
      ...
      <bpmndi:BPMNShape id="BPMNShape_16a4u7c" bpmnElement="Participant_1ypyzs0" isHorizontal="true" isMessageVisible="true" participantBandKind="top_initiating" choreographyActivityShape="ChoreographyTask_19pqmow_di">
        <dc:Bounds x="670" y="270" width="100" height="20" />
      </bpmndi:BPMNShape>
      <bpmndi:BPMNShape id="BPMNShape_0lxdk6f" bpmnElement="Participant_1u1zdeg" isMessageVisible="true" participantBandKind="bottom_non_initiating" choreographyActivityShape="ChoreographyTask_19pqmow_di">
      ...
      <bpmndi:BPMNShape id="BPMNShape_0qcqva2" bpmnElement="Participant_0hk3i22" isHorizontal="true" isMessageVisible="true" participantBandKind="bottom_non_initiating" choreographyActivityShape="ChoreographyTask_0yuyl8m_di">
      ...
      <bpmndi:BPMNShape id="BPMNShape_03c8r7a" bpmnElement="Participant_0hk3i22" isMessageVisible="true" participantBandKind="top_initiating" choreographyActivityShape="ChoreographyTask_11sd49k_di">
        <dc:Bounds x="990" y="270" width="100" height="20" />
      </bpmndi:BPMNShape>
      <bpmndi:BPMNShape id="BPMNShape_0mt12dl" bpmnElement="Participant_0fl0qh5" isHorizontal="true" isMessageVisible="true" participantBandKind="bottom_non_initiating" choreographyActivityShape="ChoreographyTask_11sd49k_di">
      ...
      <bpmndi:BPMNShape id="BPMNShape_0hz78qw" bpmnElement="Participant_1u1zdeg" isMessageVisible="true" participantBandKind="top_initiating" choreographyActivityShape="ChoreographyTask_1tjiga2_di">
        <dc:Bounds x="1150" y="270" width="100" height="20" />
      </bpmndi:BPMNShape>
      <bpmndi:BPMNShape id="BPMNShape_1y7olht" bpmnElement="Participant_0vb4wl7" isMessageVisible="true" participantBandKind="bottom_non_initiating" choreographyActivityShape="ChoreographyTask_1tjiga2_di">
